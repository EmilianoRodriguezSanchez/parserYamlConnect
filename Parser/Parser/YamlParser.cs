...
namespace YamlParserConnect.Parser
{
    ...
    public class ContextYaml : IDYamlNode<Dictionary<object, object>>
    {
        ...
        public YamlAPIConnectParser.Entity.GettingStarted Data { get; set; }
    ...
    {
        public static YamlAPIConnectParser.Entity.GettingStarted FromJson(string json) => JsonConvert.DeserializeObject<YamlAPIConnectParser.Entity.GettingStarted>(json, Converter.Settings);
    }
    ...
    public class YamlParser
    {
        ...
        public YamlAPIConnectParser.Entity.GettingStarted Load(string filePath)
        {
